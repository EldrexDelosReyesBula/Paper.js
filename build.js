...
`;
    ...
    fs.writeFileSync(path.join(__dirname, 'paper.js'), paperCode, 'utf8');
    ...
    // 5. Build paper-complete.js (Complete Showcase Bundle)
...
`;
    ...
    fs.writeFileSync(path.join(__dirname, 'paper-complete.js'), paperCompleteCode, 'utf8');
    console.log("✨ compiled paper-complete.js successfully!");
